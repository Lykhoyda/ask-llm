...
| **Gemini** | Whole-codebase reads (1M+ tokens) | `gemini-3.1-pro-preview` → `gemini-3.8-flash` | ⚠️ Enterprise-gated from 2026-06-18 |
...
|----------|---------|----------|
| Gemini | `gemini-3.1-pro-preview` | `gemini-3.8-flash` (on quota) |
