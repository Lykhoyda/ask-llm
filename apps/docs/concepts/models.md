...
```text
Use ask-llm with provider gemini and model gemini-3.8-flash to quickly check this CSS file
```

Or programmatically:

```json
{ "name": "ask-llm", "arguments": { "provider": "gemini", "model": "gemini-3.8-flash", "prompt": "..." } }
```
