...
export const PROVIDER_DOCS: Record<ProviderId, ProviderDoc> = {
  codex: {
    ...
    tier: "hero",
    tagline: "GPT-6 Astra workhorse reviewer. Strongest code reasoning for targeted reviews and architecture critique.",
  ...
  claude: {
    ...
    tier: "hero",
    tagline: "Opus 5.5 read-only reviewer for Codex CLI and other non-Claude hosts. The reverse path.",
  ...
  grok: {
    ...
    defaultEffort: "high",
    tier: "supporting",
    tagline: "Grok 4.7 through xAI's metered API. Exact model selection with no fallback.",
