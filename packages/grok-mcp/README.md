...
For the model-neutral Cursor Agent harness, use `ask-cursor-agent` from `@ask-llm/mcp`; it requires separate provider and exact `agent --list-models` ID fields and never changes Cursor spend/trust settings.
