...
export const ERROR_MESSAGES = {
  ...
  QUOTA_EXCEEDED_SHORT: "⚠️ Gemini Pro daily quota exceeded. Please retry with model: 'gemini-3.8-flash'",
...
export const MODELS = {
  ...
  FLASH: process.env.ASK_GEMINI_FALLBACK_MODEL || "gemini-3.8-flash",
};
