...
async function runArm({ armName, templatePath, fixtures, model, timeoutMs, }) {
    ...
    for (const fixture of fixtures) {
        ...
        try {
            ...
            process.stderr.write(`done — recall ${(fixtureScore.recall * 100).toFixed(0)}% (${fixtureScore.caught.length}/${fixture.probes.should_flag.length}), ${fixtureScore.extra.length} extra, ${(Date.now() - startedAt) / 1000}s\n`);
        }
        catch (err) {
