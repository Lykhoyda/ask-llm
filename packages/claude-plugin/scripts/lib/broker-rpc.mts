...
// App-server responses may omit the jsonrpc discriminator; correlate by id and dispatch notifications by method.
import type { WebSocketConnection } from "./broker-transport.mts";
